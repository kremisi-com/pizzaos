...
const MOCK_ORDERS: Order[] = [
  {
    ...
    storeId: "s1",
    customerId: "c1",
    contact: { firstName: "Cliente", lastName: "Uno", email: "uno@example.test", phone: "+39 333 0000001" },
    fulfillment: { method: "pickup", storeId: "s1" },
  ...
  },
  {
    ...
    storeId: "s1",
    customerId: "c2",
    contact: { firstName: "Cliente", lastName: "Due", email: "due@example.test", phone: "+39 333 0000002" },
    fulfillment: { method: "pickup", storeId: "s1" },
    status: "received",
    lines: [],
    subtotal: { amountCents: 0, currencyCode: "EUR" },
  ...
  },
  {
    ...
    storeId: "s1",
    customerId: "c3",
    contact: { firstName: "Cliente", lastName: "Tre", email: "tre@example.test", phone: "+39 333 0000003" },
    fulfillment: { method: "pickup", storeId: "s1" },
    status: "delivered",
    riderId: "r1",
    lines: [],
