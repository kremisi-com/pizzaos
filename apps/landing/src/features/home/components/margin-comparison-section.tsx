        ...
        >
            <div className={styles.inner}>
                ...
                <p className={styles.subtitle}>
                    Marketplace, sito semplice o PizzaOS: cambia il canale, ma
                    soprattutto cambia il profitto finale.
                    <br />
                    ...
                    >
                        ...
                        <div className={styles.cumulativeList}>
                            {CUMULATIVE_ITEMS.map((item) => (
                                <article
                                    className={styles.cumulativeItem}
                                    key={item.title}
                                >
                                    <span>{item.icon}</span>
                                    <div>
                        ...
                        <div className={styles.profitBlock}>
                            ...
                            <p>
                                Non per una singola feature, ma per la somma di
                        ...
                        <div className={styles.note}>
                            ...
                            <p>
                                <strong>
                                    I costi visibili li vedono tutti.
                                </strong>
                                Quelli invisibili sono quelli che riducono il
                                margine.
                            </p>
                        </div>
                    </aside>
