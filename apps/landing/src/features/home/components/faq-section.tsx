...
const QUESTIONS = [
  {
    ...
    answer:
      "Scegli i prodotti, personalizza la tua pizza, seleziona orario e metodo di pagamento e conferma. È tutto da app!",
  },
  {
    icon: <GroupIcon />,
    title: "Posso ordinare insieme ad amici o familiari?",
    answer:
      "Certo! Con il menu condiviso potete aggiungere prodotti insieme da dispositivi diversi e pagare anche in modalità split.",
  },
  {
    icon: <ClockIcon />,
    title: "Posso modificare o annullare un ordine?",
    answer:
      "Sì, puoi modificare o annullare l'ordine entro i tempi indicati dallo stato dell'ordine nella sezione “I miei ordini”.",
  },
  {
    icon: <TicketIcon />,
    title: "Come funziona la tessera fedeltà?",
    answer:
      "Ogni ordine ti fa guadagnare punti. Raggiungi le soglie e ottieni sconti, prodotti gratuiti e premi esclusivi.",
  },
  {
    icon: <PinIcon />,
    title: "Come funziona il tracciamento del rider?",
    answer:
      "Appena l'ordine viene affidato al rider, puoi seguirlo in tempo reale sulla mappa e ricevere aggiornamenti sullo stato della consegna.",
  },
  {
    icon: <PhoneIcon />,
    title: "Cosa succede se chiamo la pizzeria?",
    answer:
      "Dopo un messaggio automatico con il link per ordinare, se rimani in linea oltre il tempo indicato verrai messo in contatto con noi.",
  },
  {
    icon: <CardIcon />,
    title: "Quali metodi di pagamento sono accettati?",
    answer:
      "Accettiamo carte, Apple Pay, Google Pay, PayPal e Satispay. Puoi anche pagare in contanti alla consegna, se disponibile.",
  },
  {
    icon: <StoreIcon />,
    title: "PizzaOS è adatto anche a catene o più sedi?",
    answer:
      "Sì! Puoi gestire più locali e sedi da un unico pannello, con dati consolidati e impostazioni personalizzate per ogni punto vendita.",
  },
  {
    icon: <ReceiptIcon />,
    title: "Riceverò la fattura o lo scontrino?",
    answer:
      "Sì, ricevi fattura e scontrino elettronico automaticamente via email, WhatsApp o direttamente nell'app.",
  },
  {
    icon: <LockIcon />,
    title: "I miei dati e i pagamenti sono sicuri?",
    answer:
      "Assolutamente sì. Utilizziamo i più alti standard di sicurezza e i dati sono protetti secondo il GDPR.",
  },
] as const;
...
function QuestionIcon(): ReactElement {
  return (
    <IconBase>
      ...
      <path d="M9.8 9.2a2.4 2.4 0 0 1 4.6 1.1c0 1.8-2.4 2-2.4 3.8" />
      <path d="M12 17.4h.1" />
    </IconBase>
  );
}
...
function ScooterIcon(): ReactElement {
  return (
    <IconBase>
      <path d="M4 16h7l1.5-7H9L8 5H5" />
      <path d="M13 16h3l2-5h3v5h-1" />
...
function StoreIcon(): ReactElement {
  return (
    <IconBase>
      ...
      <path d="M9 19v-5h6v5" />
      <path d="M4 10c0 1.2 1 2 2 2s2-.8 2-2c0 1.2 1 2 2 2s2-.8 2-2c0 1.2 1 2 2 2s2-.8 2-2c0 1.2 1 2 2 2s2-.8 2-2" />
    </IconBase>
  );
}
...
function GroupIcon(): ReactElement {
  return (
    <IconBase>
      ...
      <path d="M13.5 16c.8-.7 1.9-1 3.2-1 2.3 0 3.8 1.2 4.3 3.8" />
    </IconBase>
  );
}
...
function TicketIcon(): ReactElement {
  return (
    <IconBase>
      ...
      <path d="m9 10 .7 1.4 1.6.2-1.1 1.1.3 1.6L9 13.5l-1.4.8.2-1.6-1.1-1.1 1.6-.2L9 10Z" />
...
function PhoneIcon(): ReactElement {
  return (
    <IconBase>
      <path d="M7 4 9.4 7.8 8 9.4c1.1 2.2 2.4 3.5 4.6 4.6l1.6-1.4L18 15l-.7 3c-.2.9-1 1.4-1.9 1.2C9.8 18.2 5.8 14.2 4.8 8.6 4.6 7.7 5.1 6.9 6 6.7L7 4Z" />
    </IconBase>
  );
}
