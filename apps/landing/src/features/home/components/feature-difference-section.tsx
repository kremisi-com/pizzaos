      ...
      <div className={styles.customizerPanel}>
        ...
        <div className={styles.optionGrid}>
          {CUSTOM_OPTIONS.map((option) => (
            <span
              className={option.active ? styles.optionActive : ""}
              key={option.label}
            >
              {option.label}
            </span>
  ...
  return (
    <div className={styles.trackingPanel}>
      ...
      <svg className={styles.routeMap} viewBox="0 0 330 240" aria-hidden="true">
        <path
          className={styles.mapWide}
          d="M8 28h304M20 92h290M12 156h300M44 8v220M108 12v212M178 8v220M250 12v212M306 22v200"
        />
        <path
          className={styles.mapThin}
          d="M8 58 304 12M28 132 316 76M12 208 314 142M76 226 308 44M2 112 124 22M182 226 318 86"
        />
        <path
          className={styles.routePath}
          d="M126 112 160 146 214 116 248 154"
        />
      ...
      <div className={styles.statusRow}>
        {["Ricevuto", "In preparazione", "In consegna", "Consegnato"].map(
          (step, index) => (
    ...
    <div className={styles.aiPanel}>
      ...
      {AI_INSIGHTS.map((insight) => (
        <div className={styles.insightCard} key={insight.text}>
          ...
          <span
            className={`${styles.insightVisual} ${styles[`insightVisual-${insight.visual}`]}`}
          />
        </div>
      ))}
    </div>
    ...
    >
      <div className={styles.inner}>
        ...
        <p className={styles.subtitle}>
          ...
          migliorare l&apos;esperienza dei tuoi clienti e aumentare i tuoi
          guadagni.
        </p>
        ...
        <div className={styles.footerNote}>
          <HeartIcon />
          <span>
            Tutte le funzionalità sono integrate. Zero complicazioni, solo
            risultati.
          </span>
        </div>
