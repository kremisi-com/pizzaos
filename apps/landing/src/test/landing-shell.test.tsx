...
describe("landing shell", () => {
    ...
    it("mounts the primary landing sections", () => {
        ...
        expect(markup).toContain("Pensato per il ritmo reale di una pizzeria");
    ...
    it("renders the FAQ section from the supplied screen", () => {
        ...
        expect(markup).toContain(
            "Serve ancora aiuto o sei interessato a PizzaOS?",
        );
        ...
        expect(markup).toContain("/brand/logo-horizontal-color.svg");
        expect(markup).toContain(
            "La piattaforma completa per pizzerie moderne.",
        );
    });
