...
- [X] Maintenance: Prepare shared, accessible network states (loading, recoverable error/retry, expired session, and temporary unavailability) before API integration.
